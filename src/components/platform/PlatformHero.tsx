    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-24 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-slide-up">
          <span className="text-foreground">{t("platform.hero.title1")} </span>
          <span className="text-gradient-green">{t("platform.hero.titleHighlight1")}</span>
          <span className="text-foreground">.</span>
          <br />
          <span className="text-foreground">{t("platform.hero.title2")} </span>
          <span className="text-gradient-green">{t("platform.hero.titleHighlight2")}</span>
          <span className="text-foreground">.</span>
        </h1>
        ...
        <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-3xl mx-auto mb-10 animate-slide-up animate-delay-200 leading-relaxed">
          ...
          <span className="text-foreground font-medium"> {t("platform.hero.subtitleHighlight")}</span>
          {" "}{t("platform.hero.subtitleEnd")} <span className="text-tennis-green font-semibold">Ace Pro</span>.
        </p>
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{t("platform.hero.mockUser.level")} • 23 {t("platform.hero.mockUser.matches")}</p>
                </div>
              </div>
              <div className="hidden sm:flex items-center gap-2">
                <span className="px-3 py-1 rounded-full bg-tennis-green/20 text-tennis-green text-sm font-medium">Ace Pro</span>
              </div>
            </div>
